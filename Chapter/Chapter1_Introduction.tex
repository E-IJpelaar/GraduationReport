...
\begin{itemize}
    ...
    \item Chapter 3: Modeling and determination of pump dynamics
    \item Chapter 3: Modeling and determination of non-linear soft robot stiffness
    \item Chapter 4: Development of a model-based control law
    \item Chapter 5: Experimental implementation of model-based controller
\end{itemize}
