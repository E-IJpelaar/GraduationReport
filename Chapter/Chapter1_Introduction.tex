...
The fundamentals of this research are provided in \cite{Caasenbrood2020}, which developed a framework to model the soft robot dynamics. This model can be valuable for soft robotic control. Therefore the research question that we try to answer is:
...
\begin{figure}[H]
    ...
    \caption{Thesis lay-out and control set-up.}
    \label{fig:my_label}
\end{figure}
